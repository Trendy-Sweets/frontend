          ...
          <div className="form__block">
            <div className="form__block-left">
              <div className="from__line-inputs">
                <input className="from__inputs" placeholder="ПІБ" type="text"
                value={fio}
                onChange={handleChangeFio}  />
                <input className="from__inputs" placeholder="E-MAIL" type="text" 
                value={email}
                onChange={handleChangeEmail} />
                <input className="from__inputs" placeholder="ТЕЛ+38(123)456 78 90" type="number" 
                value={phone}
              ...
              <div className="form__line__form">
                <div className="form__form-left from-form__block">
                  ...
                  <select className="form__box">
                    ...
                    <option className="form__box-opt">{region?region.region_name:""}</option>
                  </select>
                  <select className="form__box">

                    <option className="form__box-opt">{citi?citi.city_name:""}</option>
                  </select>
                  <input className="form__box from__input-ctile"  placeholder="АДРЕСА" type="text"
                   value={address}
                ...
                <div className="form__form-right from-form__block">
                    ...
                    <input className="form__box from__input-ctile"  placeholder="ДАТА 00-00-2029" type="text" 
                    value={date}
                    onChange={handleChangeDate} />
                    <input className="form__box from__input-ctile"  placeholder="ЧАС 09 or 19" type="number"
                    value={time}
              ...
              <div className="form__inpput-tovar">
                    <button className="dropbtn"><span>МОЄ ЗАМОВЛЕННЯ</span> <img src={strelcka} alt=""/></button>
            ...
            <div className="form__right-block">
              <div className="form__line">
                <span className="form__text-delivary">До безкоштовної доствки</span>
                <span className="form__sum"
                  >228<span className="form__value">грн</span></span>
              </div>
              <div className="form__line line-mide">
                <span className="form__text-delivary">Сума заказу</span>
                <span className="form__sum"
                  >1000<span className="form__value">грн</span></span>
              </div>
              <div className="form__line">
                <span className="form__text-delivary">Разом</span>
                <span className="form__sum"
                  ><span className="form__final-price"
                    >1228<span className="form__value">грн</span></span>
                  <div className="form__dop-info">
                    Без урахування доставки
                  </div></span>
              </div>
              <div className="form__line">
                <button className="form__design" onClick={() => postData()} >Сплатити замолвення</button>
              </div>
            </div>
          </div>
        </div>
